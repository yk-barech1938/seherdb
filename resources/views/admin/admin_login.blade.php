		...
		<div class="page-wrapper full-page">
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-4 pe-md-0">
                  <div class="authlogin-side-wrapper" style="height: 100%;">
                  <img src="{{ asset('../../../assets/images/SeherAdmin.png') }}" alt="Seher Admin Image" style="width: 100%; height: 100%;">

                  </div>
                </div>
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">SEHER<span> Login</span></a>
