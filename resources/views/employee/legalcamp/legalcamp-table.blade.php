			...
			<div class="page-content">
				...
				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Legal Camp Beneficiaries</li>
					</ol>
				</nav>
        <!-- Chart  -->
        <div class="row">
                      ...
                      <div class="col-6 col-md-12 col-xl-5">
                        ...
                        <div class="d-flex align-items-baseline">
                          ...
                          <i class="fa fa-male" aria-hidden="true" ></i>
                            ...
                            <span style="display: block;"><strong>Refugees:</strong> [ {{$countRefMale}} ]</span>
                          </p>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-5">
                        ...
                        <div class="d-flex align-items-baseline">
                          ...
                          <span style="display: block;"><strong>Refugees:</strong> [ {{$countRefFemale}} ]</span>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    @php
                      $totalHost = $countHostFemale+ $countHostMale;
                      $totalRef = $countRefFemale+ $countRefMale;
                    @endphp
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-5">
                        ...
                        <div class="d-flex align-items-baseline">
                          ...
                          <span style="display: block;"><strong>Host:</strong> {{$totalHost}}</span>
                          <span style="display: block;"><strong>Refugees:</strong> [ {{$totalRef}} ]</span>
                          </p>
                        </div>
                      </div>
                      <div class="col-6 col-md-12 col-xl-7">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="#" method="POST" id="add_cbpl_participants" class="needs-validation">
                    <!-- @csrf -->
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" id="add_cbpl_benef_btn" class="btn btn-primary">Add Beneficiary</button>
                    </div>
                </form>
...
<script>
  $(document).ready(function(){
    $('#add_cbpl_benef_btn').click(function(e){
  ...
  $(function(){
    $("#add_cbpl_participants").submit(function(e){
        e.preventDefault();
        ...
        $("#add_cbpl_benef_btn").text('Adding...');
        console.log('Adding Run');
        $.ajax({
          url: '{{ route('legalcampstore.participants') }}',
          ...
          contentType: false,
            success: function(res){
              ...
              if(res.success === true){
                ...
                $("#add_cbpl_benef_btn").text('Add Beneficiary');
                $("#add_cbpl_participants")[0].reset();
