$(function() {
  ...
  // Employee Date Disable 
  if ($('#dashboardDates').length) {
    flatpickr("#dashboardDates", {
      wrap: true,
      dateFormat: "d-M-Y",
      defaultDate: "today",
      minDate: "today",
...
// session Chart
if($('#ordersChartForSession').length) {
  var options2 = {
    chart: {
      type: "bar",
      height: 60,
    ...
    series: [{
      name: '',
      data: [3, 77, 52, 90, 74, 35, 55, 23, 47, 10, 63]
    }],
    xaxis: {
      type: 'datetime',
      categories: ["Jan 01 2022", "Jan 02 2022", "Jan 03 2022", "Jan 04 2022", "Jan 05 2022", "Jan 06 2022", "Jan 07 2022", "Jan 08 2022", "Jan 09 2022", "Jan 10 2022", "Jan 11 2022",],
  ...
  new ApexCharts(document.querySelector("#ordersChartForSession"),options2).render();
}
